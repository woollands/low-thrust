...
void mee_state_costates( double t, double* x, double* dxdt ){
  ...
  double rho = 1.0;
  double c   = 37.6811582923398;
  double Thr = 0.5;
  double eta = 0.102054400401405;
